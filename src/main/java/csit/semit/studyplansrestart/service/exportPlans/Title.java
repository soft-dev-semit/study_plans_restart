...
public class Title {
  ...
  public void createHeader(Sheet sheet) {
    ...
    sheet
        .createRow(3)
        .createCell(0)
        .setCellValue("НАЦІОНАЛЬНИЙ ТЕХНІЧНИЙ УНІВЕРСИТЕТ \"ХАРКІВСЬКИЙ ПОЛІТЕХНІЧНИЙ ІНСТИТУТ\"");
    ...
    elevenRow
        .createCell(1)
        .setCellValue("\"___\"_______________ " + LocalDate.now().getYear() + " р.");
  ...
  public void fillTable(Sheet sheet) {
    ...
    row19
        .createCell(54)
        .setCellFormula("COUNTIF(B19:W19,BL20)+COUNTIF(B19:W19,BM20)+COUNTIF(B19:W19,BN20)");
    row19
        .createCell(55)
        .setCellFormula("COUNTIF(X19:BA19,BL20)+COUNTIF(X19:BA19,BM20)+COUNTIF(X19:BA19,BN20)");
    row19
        .createCell(56)
        .setCellFormula("COUNTIF(B20:W20,BL20)+COUNTIF(B20:W20,BM20)+COUNTIF(B20:W20,BN20)");
    row19
        .createCell(57)
        .setCellFormula("COUNTIF(X20:BA20,BL20)+COUNTIF(X20:BA20,BM20)+COUNTIF(X20:BA20,BN20)");
    row19
        .createCell(58)
        .setCellFormula("COUNTIF(B21:W21,BL20)+COUNTIF(B21:W21,BM20)+COUNTIF(B21:W21,BN20)");
    row19
        .createCell(59)
        .setCellFormula("COUNTIF(X21:BA21,BL20)+COUNTIF(X21:BA21,BM20)+COUNTIF(X21:BA21,BN20)");
    row19
        .createCell(60)
        .setCellFormula("COUNTIF(B22:W22,BL20)+COUNTIF(B22:W22,BM20)+COUNTIF(B22:W22,BN20)");
    row19
        .createCell(61)
        .setCellFormula("COUNTIF(X22:BA22,BL20)+COUNTIF(X22:AQ22,BM20)+COUNTIF(X22:AQ22,BN20)");
  ...
  public void fillTimeline(Sheet sheet) {
    ...
    for (int i = 2; i <= 52; i++) {
      seventeenRow
          .createCell(i)
          .setCellFormula(CellReference.convertNumToColString(i - 1) + "18+1");
    }
