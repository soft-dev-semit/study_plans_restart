...
public class FacultyService {
  ...
  public Faculty facultyById(Long faculty_id) {
    return facultyRepository
        .findById(faculty_id)
        .orElseThrow(() -> new RuntimeException("wrong faculty_id"));
  }
  ...
  public Faculty create(CreateFacultyDTO facultyDTO) {
    Optional<Faculty> existingFaculty =
        facultyRepository.findByCodeAndName(facultyDTO.getCode(), facultyDTO.getName());
    return existingFaculty.orElseGet(
